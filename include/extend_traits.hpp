...
struct is_pod_new<
    T,
    typename std::enable_if<((std::is_standard_layout<T>::value) && (std::is_trivial<T>::value))>::type>: std::true_type
{ };
...
struct is_trivial_serializable<
    T,
    typename std::enable_if<((is_pod_new<T>::value) || (std::is_arithmetic<T>::value))>::type>: std::true_type
{ };
...
struct has_random_access_iteratior<
    ...
    true,
    typename std::enable_if<
        is_random_access_iteratior<typename Container::iterator::iterator_category>::value>::type>: std::true_type
{ };
...
{ };
template<typename T>
struct is_contiguous_container<T, typename std::enable_if<has_random_access_iteratior<T>::value>::type>: std::true_type
{ };
...
{ };
template<typename T>
struct is_fw_iterable_container<T, typename std::enable_if<has_forward_iteratior<T>::value>::type>: std::true_type
{ };
...
struct is_serializable_object<
    T,
    typename std::enable_if<((HasMemberT_Serialize<T>::value) && (HasMemberT_Deserialize<T>::value))>::type>: std::true_type
{ };
